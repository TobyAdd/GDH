...
namespace ImGuiHook {
    ...
    void setup(cocos2d::CCEGLView *view) {
        ...
        window = WindowFromDC(*reinterpret_cast<HDC *>(reinterpret_cast<uintptr_t>(glfwWindow) + 632));
    ...
    void __fastcall toggleFullScreen_H(cocos2d::CCEGLView *self, bool fullscreen, bool borderless)
    {
        destroy();
    ...
    {
        hookFunc(
                (void*)GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "?swapBuffers@CCEGLView@cocos2d@@UEAAXXZ"),
                (void*)swapBuffers_H, (void **)&swapBuffers
        );

        hookFunc(
                (void*)GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "?pollEvents@CCEGLView@cocos2d@@QEAAXXZ"),
                (void*)pollEvents_H, (void **)&pollEvents
        );

        hookFunc(
                (void*)GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "?toggleFullScreen@CCEGLView@cocos2d@@QEAAX_N0@Z"),
