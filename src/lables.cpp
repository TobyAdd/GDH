...
bool labels::time24_enabled = false;
bool labels::time12_enabled = false;
bool labels::noclip_accuracy_enabled = false;
bool labels::cps_counter_enabled = false;
bool labels::death_enabled = false;
bool labels::custom_text_enabled = false;
